...
namespace Cross_Game.DataManipulation
{
    ...
    /// <summary>
    /// Contains information about simulated mouse input.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    struct MouseInput
    {
    ...
    /// <summary>
    /// Contains information about simulated keyboard input.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    /// <summary>
    /// Contains information about a simulated input device message.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    /// <summary>
    /// Clase de apoyo para utiliar funciones nativas de c++.
    /// </summary>
    class Win32API
    {
        /// <summary>
        ...
        /// <summary>
        /// Retrieves a handle to the foreground window (the window with which the user is currently working). The system assigns a slightly higher priority to the thread that creates 
        /// the foreground window than it does to other threads.
        /// </summary>
        [DllImport("user32.dll")]
        public static extern IntPtr GetForegroundWindow();
        /// <summary>
        /// Retrieves the device context (DC) for the entire window, including title bar, menus, and scroll bars. A window device context permits painting anywhere in a window, 
        /// because the origin of the device context is the upper-left corner of the window instead of the client area.
        /// </summary>
        [DllImport("user32.dll")]
        public static extern IntPtr GetWindowDC(IntPtr hWnd);
        /// <summary>
        /// Releases a device context (DC), freeing it for use by other applications. The effect of the ReleaseDC function depends on the type of DC. It frees only common and window DCs. 
        ...
        /// <summary>
        /// BitBtl dwRop attribute: Copies the source rectangle directly to the destination rectangle.
        /// </summary>
